...
#define AFTER_PCALL(l) { if (BaseConfig::getMe().getInnerBranch() != BRANCH_PUBLISH) lua_pop(l, 1); }
    ...
    struct table_obj
    {
        ...
        RVal call(const char* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            ...
            if(lua_isfunction(m_L,-1))
            {
                ...
                push(m_L, arg3);
                push(m_L, arg4);
                if(lua_pcall(m_L, 4, 1, errfunc) != 0)
                {
                    AFTER_PCALL(m_L);
                }
            }
    ...
    struct table
    {
        ...
        RVal call(const char* name, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            return m_obj->call<RVal,T1,T2,T3,T4>(name,arg1,arg2,arg3,arg4);
        }
        // member
